...
namespace OrusFinancas.Migrations
{
    ...
    [Migration("20251003121424_AdicionarRelacionamentoTransacaoTag")]
    partial class AdicionarRelacionamentoTransacaoTag
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrusFinancas.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OrusFinancas.Models.TransacaoTag", b =>
                {
            ...
            modelBuilder.Entity("OrusFinancas.Models.TransacaoTag", b =>
                {
                    b.HasOne("OrusFinancas.Models.Tag", "Tag")
                        .WithMany("TransacoesTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OrusFinancas.Models.Transacao", "Transacao")
                        .WithMany("TransacoesTags")
